...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1280,
...
class OTESwinTransformer(SwinTransformer):
    def __init__(self, version, **kwargs):
        if version == "tiny":
            ...
            raise ValueError("Unsupported SwinTransformer version {}".format(version))
        ...
        if 'pretrained' in kwargs:
            self.pretrained = kwargs.pop('pretrained')
